...
import com.jcl.parcialplataformas.presentation.AssetDetailState
...
class AssetDetailViewModel(
    ...
    private val _uiState = MutableStateFlow(AssetDetailState())
    val uiState: StateFlow<AssetDetailState> = _uiState
    ...
    fun loadAsset(assetId: String) {
        viewModelScope.launch {
            ...
            val remoteResult = repository.fetchAssetDetailOnline(assetId)

            remoteResult
                .onSuccess { detail ->
                    _uiState.value = AssetDetailState(
                        isLoading = false,
                        error = null,
                        asset = detail,
                ...
                .onFailure {
                    val offline = repository.getOfflineAssetDetail(assetId).firstOrNull()
                    if (offline != null) {
                        _uiState.value = AssetDetailState(
                            isLoading = false,
                            error = null,
                        ...
                        _uiState.value = AssetDetailState(
                            isLoading = false,
                            error = "No se pudo cargar el asset",
                            asset = null,
        ...
        fun provideFactory(context: Context): ViewModelProvider.Factory =
            object : ViewModelProvider.Factory {
                ...
                override fun <T : ViewModel> create(modelClass: Class<T>): T {
                    ...
                    return AssetDetailViewModel(repo) as T
                }
            }
    }
}
